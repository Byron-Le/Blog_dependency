...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Byron', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '想长成猫头鹰🦉', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://byron-x.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'byron, 博客', // 网站关键词 英文逗号隔开
